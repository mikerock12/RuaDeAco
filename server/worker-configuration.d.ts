/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 75499504622226c14683a446eab62be9)
...
interface __BaseEnv_CloudflareBindings {
	...
	MATCH_ROOMS: DurableObjectNamespace<import("./src/index").GameRoom>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SESSION_TTL_SECONDS" | "SOCKET_TICKET_TTL_SECONDS" | "ROOM_TTL_SECONDS" | "EMPTY_ROOM_TTL_SECONDS" | "RECONNECT_GRACE_SECONDS" | "INPUT_DELAY_FRAMES" | "TICKET_SECRET">> {}
}
